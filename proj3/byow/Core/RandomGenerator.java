...
public class RandomGenerator {
    ...
    private ArrayList<Point> targetTilePositions;
    ...
    public RandomGenerator(TETile[][] world, Random RANDOM, String moves, TETile avatar) {
        this.RANDOM = RANDOM;
    ...
    public void drawListOfRooms(){
        ...
        int currNum = numRoom;
        for (int i = 0; i < numRoom * 2; i += 1) {
            Point targetP = targetTilePositions.get(i);
    ...
    public void drawHallWays() {
        for (int i = 0; i < roomList.size() - 1; i += 1) {
            Hallway hw = new Hallway(world, roomList.get(i), roomList.get(i + 1));
            hw.drawHallWay();
        }

    }
    public Point getStarP() {
        return startPoint;
    }
